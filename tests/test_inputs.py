...
import abaqus_parser, abaqus_lexer
...
class Inputs(unittest.TestCase):
    def test_1(self):
        ...
        buf = f.read()
        f.close()
        parser = abaqus_parser.AbaqusParser(lex_optimize=True, yacc_debug=True, yacc_optimize=False)
    ...
    def test_2(self):
        ...
        f.close()
        parser = abaqus_parser.AbaqusParser(lex_optimize=True, yacc_debug=True, yacc_optimize=False)
        t = parser.parse(buf, 'test_2.inp', debuglevel=2)
